...
execute if score #time sekunden matches 60 run scoreboard players add #time minuten 1
execute if score #time sekunden matches 60 run scoreboard players remove #time sekunden 60
execute if score #time minuten matches 60 run scoreboard players add #time stunden 1
execute if score #time minuten matches 60 run scoreboard players remove #time minuten 60
